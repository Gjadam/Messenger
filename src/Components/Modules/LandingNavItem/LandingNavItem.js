...
export default function LandingNavItem({ text }) {
    return (
        <>
            <a href="" className='group px-4 py-1 rounded-full text-gray-600 font-bold z-50 hover:bg-sky-200 hover:text-sky-600 transition-colors'>
